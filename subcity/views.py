...
from cityadmin.serializers import *
...
def index(request):
   return render(request, "subcity/template/login.html", {})
@login_required
...
def driver_register(request):
  ...
  return render(request, 'subcity/template/driver/register_driver.html', context)
@login_required
def driver_list(request):
  profile_obj = profile.objects.all()
  drivers=driver.objects.all()
  context = {'profile': profile_obj,'driver':drivers}
  return render(request, 'subcity/template/driver/driver_list.html', context)  
@login_required
def driver_register_save(request):
  ...
  if request.method == 'POST':
    ...
    drive.save()
    return render(request, 'subcity/template/driver/register_driver.html')
  else:
   return render(request, 'subcity/template/driver/register_driver.html', context)
@login_required
def subcity_register(request):
  profile_obj = profile.objects.all()
  context = {'profile': profile_obj}
  return render(request, 'subcity/template/subcity/add_subcity.html', context)
@login_required
def subcity_list(request):
  Subcity_obj = subcity.objects.all()
  context = {'subcity': Subcity_obj}
  return render(request, 'subcity/template/subcity/subcity_list.html', context) 
@login_required 
...
def subcity_edit(request,id):
    ...
    return render(request, 'subcity/template/subcity/update_subcity.html', context)
@login_required
...
def station_register(request):
  ...
  return render(request, 'subcity/template/station/add_station.html', context)
@login_required
def station_list(request):
  Subcity_obj = station.objects.all()
  context = {'station': Subcity_obj}
  return render(request, 'subcity/template/station/station_list.html', context)
@login_required
...
def station_edit(request,id):
    ...
    return render(request, 'subcity/template/station/update_station.html', context)
@login_required
...
def route_register(request):
  ...
  return render(request, 'subcity/template/route/add_route.html', context)
@login_required
def route_list(request):
  Subcity_obj = route.objects.all()
  context = {'route': Subcity_obj}
  return render(request, 'subcity/template/route/route_list.html', context)
@login_required 
...
def route_edit(request,id):
    ...
    return render(request, 'subcity/template/route/update_route.html', context)
@login_required
...
def Assigned_vehicle_list(request):
  vehicle_obj = assign_vehicle.objects.all()
  context = {'assign_vehicle': vehicle_obj}
  return render(request, 'subcity/template/vehicle/assigned_vehicle_list.html', context)  
@login_required
def vehicle_register(request):
  sub_obj = subcity.objects.all()
  driver_obj=driver.objects.all()
  context = {'subcity': sub_obj,'driver':driver_obj}
  return render(request, 'subcity/template/vehicle/add_vehicle.html', context)
@login_required
def vehicle_list(request):
  vehicle_obj = vehicle.objects.all()
  context = {'vehicle': vehicle_obj}
  return render(request, 'subcity/template/vehicle/vehicle_list.html', context)
@login_required
...
def vehicle_edit(request,id):
    ...
    return render(request, 'subcity/template/vehicle/update_vehicle.html', context)
...
def vehicle_location(request):
    ...
    m=m._repr_html_()
    context = {'map': m}
    return render(request, 'subcity/template/vehicle/vehicle_location.html', context)
@login_required
def location(request,mid):
    ...
    #pp = folium.Popup(s_id)
    p1 = folium.Popup(v_id)
    ic = features.Icon(color='blue',icon="fa-bus", prefix='fa')
...
def machine_register(request):
  ...
  context = {'station': station_obj}
  return render(request, 'subcity/template/machine/add_machine.html', context)
@login_required
def machine_list(request):
  machine_obj = machine.objects.all()
  context = {'machine': machine_obj}
  return render(request, 'subcity/template/machine/machine_list.html', context) 

@login_required 
def machine_data_list(request):
  machine_obj = machine_data.objects.all()
  context = {'machine': machine_obj}
  return render(request, 'subcity/template/machine/machine_data_list.html', context)
...
def machine_edit(request,id):
    ...
    return render(request, 'subcity/template/machine/update_machine.html', context)
@login_required   
