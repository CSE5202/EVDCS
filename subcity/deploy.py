...
def deploy(request):
    ...
    for i in subcities:
        ...
        for j in vehicles:
            ...
            if len(valid_route_types) > 0:
                ...
                render(request,'subcity/template/deploy/deployment.html', {'deployments': deployments})
    ...
    return render(request,'subcity/template/deploy/deployment.html', {'current_deployment': current_deployment, 'past_deployments': past_deployments})
